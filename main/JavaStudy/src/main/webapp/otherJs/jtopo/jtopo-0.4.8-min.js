...
function(window) {
    ...
    JTopo = {
        ...
        faultV1:function(){
        	if(JTopo.fv1==null){
        		var jsPath = JTopo.getJsPath();
        		JTopo.fv1=new Image();
        		JTopo.fv1.src=jsPath+"img/faultV1.png";
        	}
        	return JTopo.fv1
        }, faultV2:function(){
        	if(JTopo.fv2==null){
        		var jsPath = JTopo.getJsPath();
        		JTopo.fv2=new Image();
        		JTopo.fv2.src=jsPath+"img/faultV2.png";
        	}
        	return JTopo.fv2
        }, faultV3:function(){
        	if(JTopo.fv3==null){
        		var jsPath = JTopo.getJsPath();
        		JTopo.fv3=new Image();
        		JTopo.fv3.src=jsPath+"img/faultV3.png";
        	}
        	return JTopo.fv3
        }, faultV4:function(){
        	if(JTopo.fv4==null){
        		var jsPath = JTopo.getJsPath();
        		JTopo.fv4=new Image();
        		JTopo.fv4.src=jsPath+"img/faultV4.png";
        	}
        	return JTopo.fv4
        }, faultV5:function(){
        	if(JTopo.fv5==null){
        		var jsPath = JTopo.getJsPath();
        		JTopo.fv5=new Image();
        		JTopo.fv5.src=jsPath+"img/faultV5.png";
        	}
        	return JTopo.fv5
        },
        getJsPath:function(){
    		...
    		for(var i=js.length;i>0;i--){
    		 if(js[i-1].src.indexOf("jtopo-0.4.8-min.js")>-1){
        ...
        MouseCursor: {
            ...
            move: "move",
            open_hand: "url(../img/topo/bg/1.jpg) 8 8, default",
            closed_hand: "url(../img/topo/bg/1.jpg) 8 8, default"
        },
...
function(a) {
    function b(c) {
        this.initialize = function(c) {
            ...
            this.alarmFontColor = "255,255,255",
            this.alarmFillColor = 100,
            this.borderWidth = 0,
        ...
        this.paintFault=function(a) {
        	if(this.fault&0!=this.fault){
        		if(1==this.fault){
        			a.drawImage(JTopo.faultV1(), -this.width+12, -this.height+12, 16, 16)
        		}else if(2==this.fault){
        			a.drawImage(JTopo.faultV2(), -this.width+12, -this.height+12, 16, 16)
        		}else if(3==this.fault){
        			a.drawImage(JTopo.faultV3(), -this.width+12, -this.height+12, 16, 16)
        		}else if(4==this.fault){
        			a.drawImage(JTopo.faultV4(), -this.width+12, -this.height+12, 16, 16)
        		}else if(5==this.fault){
        			a.drawImage(JTopo.faultV5(), -this.width+12, -this.height+12, 16, 16)
        		}
        	}
        },
        this.paintAlarmText = function(a) {
            if (null != this.alarm && "" != this.alarm) {
                var b = this.alarmColor || "0,0,0",
                c = this.alarmAlpha || .8;
                a.beginPath(),
                a.font = this.alarmFont || "12px 微软雅黑 ";
                var maxWidth=0;
                var maxheith=0;
                var st=this.alarm.split("\n");
				for(var i=0;i<st.length;i++){
					maxheith+=15;
					if(a.measureText(st[i]).width>maxWidth){
						maxWidth=a.measureText(st[i]).width
					}
				}
                var d = maxWidth+10,
                e = maxheith+8;
                ...
                a.closePath(),
                a.beginPath(),
                a.strokeStyle = "rgba(" + this.alarmFontColor + ", " + this.alpha + ")",
                a.fillStyle = "rgba(" + this.alarmFontColor + ", " + this.alpha + ")";
				var x=(f + 2);
				var y=(-e+4);
				for(var i=0;i<st.length;i++){
					 a.fillText(st[i], x, y+(i-1)*15);
				}
                a.closePath();
            }
        },
        ...
        this.setImage = function(b, c) {
            ...
            if ("string" == typeof b) {
                ...
                null == e ? (e = new Image, e.src = b, e.onload = function() {
                    ...
                    var f = a.util.genImageAlarm(e,35);
                    f && (e.alarm = f),
                    d.image = e
